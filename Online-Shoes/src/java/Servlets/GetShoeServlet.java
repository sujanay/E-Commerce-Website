...
public class GetShoeServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        // extract shoes entity list from session.
        ShoesEntityList shoes = (ShoesEntityList)session.getAttribute("shoesentitylist");
        
        // get shoes with the given brand and model
        Shoes shoe = shoes.getShoes(brand, model);
        session.setAttribute("currentshoe", shoe);
